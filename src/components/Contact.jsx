  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      'template_zapeixk',
      {
        ...
        to_email: 'manishnandwani5055@gmail.com',
        ...
        <div className='bg-black-100 rounded-2xl p-8'>
          ...
          <form ref={formRef} onSubmit={handleSubmit} className='mt-12 flex flex-col gap-5'>
            ...
            <textarea
              ...
              '
            />
            <button type="submit" className='px-8 py-3 shadow-primary shadow-lg w-fit rounded-2xl bg-tertiary'>{loading ? 'Sending...' : 'Send'}</button>
          </form>
        </div>
      </Slide>
